...
func FollowUser(w http.ResponseWriter, r *http.Request) {
	...
	if followerID == userID {
		responses.Err(w, http.StatusForbidden, errors.New("It is not possible to follow yourself"))
		return
	}
...
func StopFollowUser(w http.ResponseWriter, r *http.Request) {
	...
	if followerID == userID {
		responses.Err(w, http.StatusForbidden, errors.New("It is not possible to stop to follow yourself"))
		return
	}
